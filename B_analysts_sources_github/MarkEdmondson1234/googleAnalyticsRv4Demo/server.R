...
shinyServer(function(input, output, session){
  ...
  token <- callModule(googleAuth, "login", login_text = "Log In", logout_text = "Log Off")
  ...
  output$md_table <- DT::renderDataTable({
  ...
  output$calc_table <- DT::renderDataTable({
    
    myDataTable(calc_data())
