...
color <- brocolors("crayons")[c("Denim", "Jazzberry Jam", "Cornflower")]
fgcolor <- "white"
...
plot(out, col=color[1], ylab="LOD score", bandcol="gray20", incl.markers=FALSE, yaxs="i",
     ylim=c(0, 9))
...
for(y in yax)
  segments(xl[1], y, xl[2], y, col="gray30", lend=1, ljoin=1)
...
plot(out, col=color[1], ylab="LOD score", add=TRUE)
