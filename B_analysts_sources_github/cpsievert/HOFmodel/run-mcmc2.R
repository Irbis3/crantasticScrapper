...
run_mcmc <- function(dat1, dat2, alpha0 = 0, sigma_alpha0 = 1, gamma0 = 0, sigma_gamma0 = 1, 
  ...
  for (k in 2:n.reps) {
    ...
    stuff <- metropolis(alpha=alpha, gamma=gamma, sigma=sigma_alpha, jump_sd=jump_alpha, xb=xb_int, reps=repeats, y=y, n=n)
    ...
    stuff <- metropolis(alpha=alpha, gamma=gamma, sigma=sigma_gamma, jump_sd=jump_gamma, xb=xb_slope, reps=repeats, y=y, n=n, sample.alpha=FALSE)
