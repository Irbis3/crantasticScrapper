...
#' I kept detailed data on each group even in part 1, betting that I would need
#' it in part 2. That also made me shy away from leaning on regular expressions
#' for pre-processing. In hindsight, I was being paranoid and this could be much
#' simpler :( Oh well, win some, lose some.
