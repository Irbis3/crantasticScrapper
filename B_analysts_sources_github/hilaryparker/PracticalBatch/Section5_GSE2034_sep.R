...
save(list=c("celA","celB","sepA","sepB","grp"),file="Section5_GSE2034_rma_sepdata.RData")
save(list=c("frmaA","frmaB","sepA","sepB","grp"),file="Section5_GSE2034_frma_sepdata.RData")
