# The following are taken from Ross Ihaka's
# case study in making R code efficient via profiling
# and vectorization
# These are two of the several functions for simulating a 2D random walk.
# The first is the naive approach. The second is the heavily vectorized version.
